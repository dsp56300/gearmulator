...
namespace virusLib
{
	...
	void DspSingleSnow::processAudio(const synthLib::TAudioInputs& _inputs, const synthLib::TAudioOutputs& _outputs, size_t _samples, uint32_t _latency)
	{
		...
		const float* inputs0[] = {_inputs[0], _inputs[1], nullptr, nullptr, nullptr, nullptr, nullptr, nullptr};
		const float* inputs1[] = {_inputs[2], _inputs[3], nullptr, nullptr, nullptr, nullptr, nullptr, nullptr};
		...
		float* outputs0[] = {_outputs[0], _outputs[1], nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr};
		float* outputs1[] = {nullptr, nullptr, _outputs[2], _outputs[3], _outputs[4], _outputs[5], _outputs[6], _outputs[7], nullptr, nullptr, nullptr, nullptr};
