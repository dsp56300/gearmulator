...
set(VST2SDK_TESTFILE ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/vstsdk2.4.2/public.sdk/source/vst2.x/audioeffect.h)
set(VST2SDK_FOLDER ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/vstsdk2.4.2/)
...
if(NOT EXISTS ${VST2SDK_TESTFILE})
	set(VST2SDK_FOLDER ${CMAKE_CURRENT_LIST_DIR}/../3rdparty/fst/)
endif()
