...
namespace emu88Lib
{
	...
	public:
		...
		enum class BootProtocol { Sc8850, Sc8820 };
		explicit Sc8850SubMcu(BootProtocol protocol = BootProtocol::Sc8850);
		...
		void readMidiOut(std::vector<synthLib::SMidiEvent>& _output);
		void tick();
	...
	private:
		...
		std::array<synthLib::MidiBufferParser, CableCount> m_outputParsers{
