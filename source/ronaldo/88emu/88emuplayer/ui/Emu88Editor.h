...
namespace emu88Player
{
	...
	private:
		...
		friend class RomRequirementsWindow;
		...
		void selectDeviceModel(emu88Lib::DeviceModel _model, bool _restart = false, bool _powerOn = false);
