...
The `.mid` exports remain in their native binary formats so tests exercise the actual file containers. Synthetic byte construction is reserved for malformed or incomplete input tests.
