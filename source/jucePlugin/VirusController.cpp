...
namespace Virus
{
    ...
    Controller::Controller(AudioPluginAudioProcessor &p, unsigned char deviceId) : m_processor(p), m_deviceId(deviceId), m_descriptions(p.getModel() == virusLib::ROMFile::Model::Snow ? BinaryData::parameterDescriptions_Snow_json : BinaryData::parameterDescriptions_C_json)
    {
