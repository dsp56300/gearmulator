	...
	const std::initializer_list<Parameter::Description> Controller::m_paramsDescription =
{
    ...
    {Parameter::Page::A, Parameter::Class::SOUNDBANK_A, 19, "Osc1 Wave Select", {0,127}, numToOscWaveSelect, {}, true, true, false},
    ...
    {Parameter::Page::A, Parameter::Class::SOUNDBANK_A, 24, "Osc2 Wave Select", {0,127}, numToOscWaveSelect,{}, true, true, false},
