...
//==============================================================================
Editor::Editor(juce::AudioProcessor& _p, PluginEditorState& _s, juce::PropertiesFile& _config)
...
void Editor::setGuiScale(juce::Component* _comp, int percent)
{
	if(!_comp)
		return;
...
void Editor::setUiRoot(juce::Component* _component)
{
	removeAllChildren();
