...
void get_coeffs(int *coeffs,int freq,int res,int gain=0x400000)
{
...
{
	float *in1=input[0],*in2=inputs[1],*out1=outputs[0],*out2=outputs[1];
	...
	while (sampleFrames)
	{
		...
		for (int i=0;i<toprocess;i++)
		{
			...
			long long a=audio_in*coeffs[0]+history[0]*coeffs[1]+history[1]*coeffs[2]+history[2]*coeffs[3]+history[3]*coeffs[4];
			a=a<<2 + 0x400000;
			a=min(max(-8388608,a>>24),8388607);
			history[1]=history[0];history[0]=audio_in[i];
			history[3]=history[2];history[2]=a;
