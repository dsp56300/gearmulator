...
- [ ] Add support for a second relative mode for values 63/65
      - Only 0x01 (increment) and 0x7F (decrement) are currently recognized for relative mode. Add detection and handling for encoders that use 0x3F/0x41 (63/65) as decrement/increment, which is a common alternative relative mode.
- [ ] Support Pitchbend
